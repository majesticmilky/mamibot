    ...
    execute(message, args){
        const { prefix, token } = require('../config.json');
            ...
            if(args[1] === 'faq'){
                const sourceEmbed = new Discord.MessageEmbed()
                .setAuthor('FAQ')
            .setDescription('This command will let you see the bot\'s Frequently Asked Questions.')
            .addFields({name: 'Permission:', value: 'Bot Owner'})
            .setColor('#ffea61')
            .setFooter(`${message.member.user.tag}`);
            message.channel.send(sourceEmbed);
            ...
            .setDescription('This command will let you see the server\'s info.')
            .addFields({name: 'Permission:', value: 'User'})
            .setColor('#ffea61')
            .setFooter(`${message.member.user.tag}`);
            message.channel.send(sourceEmbed);
            ...
            if(args[1] === 'bi'){
                const sourceEmbed = new Discord.MessageEmbed()
                .setAuthor('Bot Info')
            .setDescription('This command will let you see the bot\'s info.')
            .addFields({name: 'Permission:', value: 'User'})
            .setColor('#ffea61')
            .setFooter(`${message.member.user.tag}`);
            message.channel.send(sourceEmbed);
            ...
            .addFields({name: 'Moderation', value:'`Ban` `Kick` `Clear` `Warn` `Mute` `Unmute` `slowmode`'},
                       ...
                       {name: 'Misc', value:'`Poll` `ui` `avatar` `bi`'},
                       {name: 'Server', value:'`Ping` `Help` `Invite` `Server` `si`'},
                       {name: 'Neko', value: '`pat` `kiss` `hug`'})
            .setFooter(`${message.member.user.tag}`);
